				...
				<div class="container">
					<div class="header header--style-1">
						<div class="logo image--logo hidden-md hidden-sm hidden-xs">
							<a href="index.html"><img src="{{asset('abasas/images/logo/logo-white.png')}}" alt="header logo"></a>
						</div>
						...
						<div class="mobile-menu hidden-lg hidden-xlg hidden-xx hidden-sp">
							<a class="mobile-logo" href="index.html"><img src="{{asset('abasas/images/logo/mobile-logo.png')}}" alt="logo"></a>
						</div>
					</div>
				</div>
			</header><!-- //Header -->