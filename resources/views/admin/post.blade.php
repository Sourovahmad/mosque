                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <div class="form-group col-12">
                            ...
                            <select class="form-control form-control" value="" name="postType" id="postType" required>
                        ...
                        <div class="form-group col-12 ">
                            <label for="video">Video Link <i class="fa fa-info-circle" title="Youtube embed code"
                                    aria-hidden="true"></i></label><br>
    ...
    $(document).ready(function () {
        ...
        $('#postType').change(function () {
            ...
            if (postType == 'event') {
                ...
                eventhtml += ' </select>';
                eventhtml +=
                    ' <button type="button" id="addPostCategory" class="btn btn-link">Add New Category</button>';
        ...
        $(document).on('click', "#addPostCategory", function () {
            ...
            html +=
                '<button type="button" id="cancel-button"  class="form-control btn btn-danger ">Cancel</button>';
            html +=
                '<button type="button" id="submit-button"  class="form-control btn btn-success ">Submit</button>';
            html += '  </div>';
            html += ' </form>';
                    ...
                    if (categories != 'Error') {
                        ...
                        categories.forEach(function (category, item) {
                            ...
                            if (len == item) {
                                ...
                                html2 += '   <option value="  ' + category.id +
