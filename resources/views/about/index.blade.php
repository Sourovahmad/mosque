...
<section class="bg-white">
    ...
    <div class="row p-4">
        ...
        <div class="col-md-4 col-sm-12 p-4">
            <div class="nav flex-column nav-pills rules-side-nav" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link " id="v-pills-organize-tab" data-toggle="pill" href="#v-pills-organize" role="tab"
                    aria-controls="v-pills-organize" aria-selected="false"     >ORGANIZED PROGRAMS / EVENTS</a>
                <a class="nav-link " id="v-pills-additional-tab" data-toggle="pill" href="#v-pills-additional" role="tab"
                    aria-controls="v-pills-additional" aria-selected="false"     >ADDITIONAL REGULATIONS</a>
            </div>
        </div>
            ...
            <div class="tab-content" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade" id="v-pills-announcement" role="tabpanel"
                    ...
                    <ul>
                        ...
                        <li> Receipt of funds collected with exact dollar amount should be signed and mailed promptly
                            after fundraising event</li>
                      
                        <li>Failure to comply with one or all of these regulations may result in consequences up to and
                    ...
                    <ul>
                        ...
                        <li> Friday announcements
                            <ul>
                                ...
                                <li> Friday announcements may be made by the Imam and/or designated member of the Masjid
                                    Committee</li>
                            </ul>
                        </li>
                        ...
                        <li> General announcements
                            <ul>
                                <li>Emergency announcements like newborn, hospitalization, accident, death, and request
                                    for du'a can be made only with the permission of Imam or a member of the Masjid
                                    Committee</li>
                                <li> Other announcements apart from those stated above require prior approval from the
                                    Masjid committee</li>
                            </ul>
                        </li>
                </div>
                <div class="tab-pane fade" id="v-pills-organize" role="tabpanel" aria-labelledby="v-pills-organize-tab">
                    <p>
                        ...
                        Those requests will require review and approval of relevant program information ( eg, program
                        summary, presentation, etc by The Masjid Committee and' or Imam. Programs may be recorded and
                        ...
                        regulations.
                        The approved individual or group responsible for conducting the program will follow the general
                    ...
                    <p>
                        Any program Volating masid policy . Islarnic law , and / or applicable local , state , and / or
                        federal laws will not be permitted . Programs should also meet requirements for IRS code Section
                ...
                <div class="tab-pane fade" id="v-pills-additional" role="tabpanel"
                    ...
                    <ul>
                        <li>Any activity, program , group , or personal activity violating besic Islamic law ( Sunni )
                            is strictly prohibited and will be canceled with or without notice . Any interpretation of
                            religious matters will be referred to the Imam </li>
                        <li> All Islamic religious matters require review and approval of Imam of Masjid Mission Center
                            ( MMC ) </li>
                        ...
                        <li> No personal items should be left outside or inside the masjid without prior approval from a
                        ...
                        <li>Vehicles should be parked in a designated parking space . Overnight parking requires
                            approval of any member of the Masjid Committee. Vehicles parked inappropriately and parked
                        ...
                        <li class="font-weight:bold"> <span class=""> CELL PHONES AND PAGERS MUST</span> be turned off
                        ...
                        <li> <span class="font-weight-bold"> SHOES</span> are not permitted on the carpeted area an MUST
                            be removed and placed in shoe racks upon entry in the Masjid . Shoes left on the tiled area
                            can be a safety hazard</li>
                        <li> <span class="font-weight-bold">YOUNG CHILDREN</span> are encouraged at the Masild but, they
                        ...
                        <li> When anyone finds others dong something wrong , he / she should ask them not to do quietly
                            and softly . Everyone shall avoid insulting others openly , or rebuking others , or
                            quarreling with others</li>
                        <li> Any complaints , suggestions , disputes or disagreements shall be brought to attention of
...
<div class="row pl-4">
    ...
    <div class="col-md-6 col-sm-12 pt-4">
        ...
        <div class="secendtitle">
            ...
            <ul>
                ...
                <li> Receipt of funds collected with exact dollar amount should be signed and mailed promptly after
                    fundraising event
                <li>
                <li>Failure to comply with one or all of these regulations may result in consequences up to and
                    including forfeiture of funds collected</li>
            ...
            <div class="thirdtitle">
                ...
                <ul>
                    ...
                    <li> General announcements
                        <ul>
                            <li>Emergency announcements like newborn, hospitalization, accident, death, and request for
                                du'a can be made only with the permission of Imam or a member of the Masjid Committee
                            </li>
                            <li> Other announcements apart from those stated above require prior approval from the
                                Masjid committee</li>
                        </ul>
    ...
    <div class="col-md-6 col-sm-12">
        <p>
            Any program Volating masid policy . Islarnic law , and / or applicable local , state , and / or federal laws
            will not be permitted . Programs should also meet requirements for IRS code Section 501 c ) ( 3 ) for
            churches of religious houses of worship
        </p>
        ...
        <div class="right_secend_title">
            ...
            <ul>
                <li>Any activity, program , group , or personal activity violating besic Islamic law ( Sunni ) is
                    strictly prohibited and will be canceled with or without notice . Any interpretation of religious
                    matters will be referred to the Imam </li>
                <li> All Islamic religious matters require review and approval of Imam of Masjid Mission Center ( MMC )
                </li>
                <li>Any activity , program by person or group that may harm , threaten or endanger any other individual
                    group will not be tolerated . Such an Individual will be appropriately reprimanded up to and
                    including expulsion from the masjid </li>
                <li> Any illegal activity by any individual or group will be reported immediately to law enforcement
                </li>
                <li>No masjid property can be borrowed , moved , or rearranged without prior approval from a member of
                    the Masjid Committee of Imam</li>
                <li> No personal items should be left outside or inside the masjid without prior approval from a member
                    of the Masjid Committee or Imam</li>
                <li>Sleepover in the masjid including Itikaf requires awareness all relevant rules and regulations and
                    therefore must be pre - approved by a member of the Masjid Committee and / or Imam Requests will not
                    be granted without an advanced request. </li>
                <li>Vehicles should be parked in a designated parking space . Overnight parking requires approval of any
                    member of the Masjid Committee. Vehicles parked inappropriately and parked overnight without prior
                    approval will be towed at owners expense</li>
                <li>The requestor assumes full responsibility for the liability of any statement and / or program
                    carried out during the event and / or by affifiated group member . Opinions expressed there are not
                    necessarily endorsed by MMC </li>
                <li class="font-weight:bold"> <span class=""> CELL PHONES AND PAGERS MUST</span> be turned off or
                    switched to vibrate during the 5 Daily Prayers and Jummah Prayer. Please show your respect for Allah
                    ( swt ) and those around you</li>
                <li> <span class="font-weight-bold"> SHOES</span> are not permitted on the carpeted area an MUST be
                    removed and placed in shoe racks upon entry in the Masjid . Shoes left on the tiled area can be a
                    safety hazard</li>
                <li> <span class="font-weight-bold">YOUNG CHILDREN</span> are encouraged at the Masild but, they MUST be
                    next to their parents during Prayer. Or any other actions consider unsafe or distracting to others
                </li>
                <li>Buying and selling of any kind in the Masjid shall be barred </li>
                <li> When anyone finds others dong something wrong , he / she should ask them not to do quietly and
                    softly . Everyone shall avoid insulting others openly , or rebuking others , or quarreling with
                    others</li>
                <li> Any complaints , suggestions , disputes or disagreements shall be brought to attention of the
                    Masjid Committee -MMC Executive Committee</li>
...
<section id="gallery" class="cr-section offer-area ptb--70 bg--pattern zig-zag--top zig-zag--bottom">
    <div class="container">
        ...
        <div class="row">
            ...
            <a mt-4 href="https://unsplash.it/1200/768.jpg?image=251" data-toggle="lightbox" data-gallery="gallery"
                class="col-md-4 mt-4">
